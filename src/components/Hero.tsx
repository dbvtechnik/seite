      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 w-full">
        <div className="max-w-4xl">
          ...
          <p className="mt-8 max-w-2xl text-lg text-ink-300 leading-relaxed animate-fade-up" style={{ animationDelay: '0.2s', opacity: 0 }}>
            Von der Lichtplanung bis zur letzten Platte – wir machen Ihre Veranstaltung
            zu einem unvergesslichen Erlebnis. Professionelle Technik, leidenschaftliche DJs
            und Pakete, die genau zu Ihrem Event passen.
          </p>
